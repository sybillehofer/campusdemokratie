...
// remove tools if user role not equal administrator
...
function joints_custom_admin_footer() {
	_e('<span id="footer-thankyou">Entwickelt von <a href="https://sybillehofer.ch" target="_blank">Sybille Hofer</a></span>.', 'jointswp');
}
...
//enable theme string translations for editors
add_action( 'admin_menu', function() {
...
// only shop update info to admins
add_action( 'admin_head', 'ne_hide_update_notice_to_all_but_admin_users', 1 );
function ne_hide_update_notice_to_all_but_admin_users()
{
